...
namespace Quixduell.ServiceLayer.DataAccessLayer.Repository.Interface
{
    public interface IStudysetRepository
    {
        ...
        Task CreateStudysetAsync(Studyset studyset);
