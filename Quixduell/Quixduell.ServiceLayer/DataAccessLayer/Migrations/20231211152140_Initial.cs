        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    answer_type = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Studysets_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hint = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    StudysetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    question_type = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BaseQuestion_Answer_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BaseQuestion_Studysets_StudysetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseQuestion_AnswerId",
                table: "BaseQuestion",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseQuestion_StudysetId",
                table: "BaseQuestion",
                column: "StudysetId");

            migrationBuilder.CreateIndex(
                name: "IX_Studysets_CategoryId",
                table: "Studysets",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Studysets_CreatorId",
                table: "Studysets",
                column: "CreatorId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Answer_BaseQuestion_MultipleChoiceQuestionId",
                table: "Answer",
                column: "MultipleChoiceQuestionId",
